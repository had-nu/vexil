...
```
v2.2.0  Current — Wardex integration, infrastructure patterns, -exclude flag
v2.3.0  Phase A  — Cross-reference + file type coverage (zero new dependencies)
v2.4.0  Phase B  — --git-aware mode (git CLI integration, optional)
v3.0.0  Phase C  — Breaking JSON envelope change: full contextual risk model
```
